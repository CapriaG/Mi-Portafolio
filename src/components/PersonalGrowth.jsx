  ...
  return (
    <div className="personal-growth-container">
      ...
      <div className="content-section">
        ...
        A lo largo de mi carrera como desarrollador y diseñador el aprendizaje ha sido una constante.<br></br> Comencé trabajando de manera independiente, donde cada proyecto me permitió adquirir nuevas habilidades y enfrentar desafíos que impulsaron mi crecimiento profesional. He aprendido a utilizar herramientas como In Design, Ilustator, Photoshop, Premiere Pro, React y Bootstrap, perfeccionando no solo mis habilidades técnicas, sino también mi capacidad para entender las necesidades de los clientes y transformarlas en soluciones funcionales. <br></br> Para mí, el aprendizaje no es solo una etapa, sino un proceso continuo y por eso estoy comprometido con mejorar cada día, explorar nuevas tecnologías y adaptarme a los cambios para seguir creciendo como profesional y contribuir de manera significativa a los proyectos en los que participo.
        </p>
      </div>
